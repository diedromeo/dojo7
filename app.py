...
# =====================================================
# Samurai CTF (Render Compatible) - same UI & challenge
# =====================================================
...
# Render-safe temp directory for writing logs
LOG_DIR = os.path.join("/tmp", SECRET_DIR, LOG_SUBDIR)
os.makedirs(LOG_DIR, exist_ok=True)

# --- fake log (visible clue) ---
...
# ============= Routes (identical challenge flow) =============
...
if __name__ == "__main__":
    print("⚔️ Samurai CTF running at http://127.0.0.1:5000 or Render PORT")
